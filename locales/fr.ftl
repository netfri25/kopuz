...
server_details = Detaile Serveur
...
login_to_service = Se connecter à { $service }
...
browse_genres = Navigé les Genres
...
back_to_browse = Retours a la navigation
back = Retour
