...
discord_presence = حضور Discord
reduce_animations = تقليل الرسوم المتحركة
show_source_toggle = إظهار تبديل المصدر
volume = الصوت
local = محلي
server = خادم
...
heart_track_to_add_server = أضف إعجابك بمقطع أثناء تشغيله لإضافته هنا ومزامنته مع خادمك.
...
# Additional Keys
no_genres_found = لم يتم العثور على أنواع في مكتبتك.
jump_back_in = استمر من حيث توقفت
by_artist = بواسطة
...
repeat_queue = تكرار: قائمة الانتظار
repeat_track = تكرار: المقطع
rescan_library = إعادة فحص المكتبة
...
text-muted = نص خافت
accent = اللون المميز
accent-soft = لون مميز ناعم
accent-alt = لون مميز بديل
accent-deep = لون مميز عميق
highlight = تمييز
